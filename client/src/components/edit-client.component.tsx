	...
	const onSubmit = (clientObject: IClientObject) => {
 	...
 	useEffect(() => {
		axios
			...
			.then((res) => {
				const  {  customer_id, first_name,
					last_name, email, gender, country, city,
					street, phone, total_price, currency, cerdit_card_type, cerdit_card_number} = res.data;
				setFormValues( {  customer_id, first_name,
					last_name, email, gender, country, city,
					street, phone, total_price, currency, cerdit_card_type, cerdit_card_number});
			})
